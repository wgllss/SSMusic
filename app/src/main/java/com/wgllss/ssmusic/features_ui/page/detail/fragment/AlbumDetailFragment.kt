...
import com.wgllss.ssmusic.features_ui.page.detail.viewmodel.AlbumViewModel
...
class AlbumDetailFragment(private val encodeIDUrl: String) : BaseViewModelFragment<AlbumViewModel>(0) {
...
//                img_author.loadUrl(it.info.list.user_avatar)
                Glide.with(this@AlbumDetailFragment).asBitmap()
